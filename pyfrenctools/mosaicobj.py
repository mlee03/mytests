...
class MosaicObj:
    ...
    def read(self):
        ...
        self.dataset = xr.open_dataset(self.input_dir+self.mosaic_file).astype(str)
    ...
    def get_grid(self) -> dict:
        ...
        for i in range(self.ntiles):
            self.grid[self.gridtiles[i]] = GridObj(gridfile=str(self.input_dir)+str(self.gridlocation)+str(self.gridfiles[i])).read()
